 ...
 * drawer) and "Cart" (a real link to /cart, carrying the live item count and
 * total). Supersedes the old cart-only bar and the separate floating
 * RecentOrdersLauncher pill, which duplicated this same screen edge.
 *
